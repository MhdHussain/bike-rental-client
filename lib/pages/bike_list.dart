      ...
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          children: <Widget>[
            ...
            _title(),
            _filterApply(),
            _cartaCoche('assets/car1.jpg', "911 Carrera 4S", Color(0xff0056ff), context),
            _cartaCoche('assets/car2.jpg', "Car 2", Color(0xff9d9d9d), context),
            _cartaCoche('assets/car3.jpg', "Car 3", Color(0xff9d9d9d), context),
            _cartaCoche('assets/car4.jpg', "Car 4", Color(0xff9d9d9d), context),
            _cartaCoche('assets/car5.jpg', "Car 5", Color(0xff9d9d9d), context),
          ],
      ),
        ),
      ),
